...
# Сначала находит пересечения (a.intersection(b))
# Потом a объединяет с b "a.union(b)"
# Затем из полученного множества находит разность с первым множеством (a.intersection(b))
